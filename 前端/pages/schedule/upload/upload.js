    ...
    methods: {
            ...
            wx.chooseMedia({
                ...
                success: (res) => {
                    ...
                    wx.uploadFile({
                        ...
                        url: 'https://自己的网址/自己的储存路径/downLoadPhoto.py',
                        success: (res) => {
        ...
        photoOCR: function () {
            if (this.data.time_ocr > 0) {
                ...
                wx.request({
                    url: 'https://自己的网址/自己的储存路径/ocr.py?table=' + this.data.table,
                    method: 'GET',
                    success: (res) => {
                        ...
                        if (res.data.success) {
                            // 识别次数-1
                            wx.request({
                                url: 'https://自己的网址/自己的储存路径/time_ocr&bool_schedule.py?openid=' + this.data.openid,
                                method: 'GET',
                                success: (res) => {
